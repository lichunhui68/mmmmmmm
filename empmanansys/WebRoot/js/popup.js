...
function uploadimg()
{
pop("/empmanansys/js/uploadimg.jsp","上传图片",300,77)
}

function uploadimg2()
{
pop("/empmanansys/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/empmanansys/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/empmanansys/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/empmanansys/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/empmanansys/js/uploaddoc.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/empmanansys/js/dialogclose.gif  />';
